...
char*  codeGen_stringFix(const char* _str) {
    ...
    memset(ret, '\0', sizeof(char)*(strlen(_str)+1)*2);
    if (_str[0] == '\"') {  // Trivial
        strcpy(ret, _str);
        return ret;
    } else {                // Raw Literals
        ...
        for (size_t iter = 1L; iter < str_len+1; iter++) {
            switch (_str[iter]) {
                case '\a': ret[ptr++] = '\\'; ret[ptr++] = 'a';  continue;
                case '\b': ret[ptr++] = '\\'; ret[ptr++] = 'b';  continue;
                case '\f': ret[ptr++] = '\\'; ret[ptr++] = 'f';  continue;
                case '\n': ret[ptr++] = '\\'; ret[ptr++] = 'n';  continue;
                case '\r': ret[ptr++] = '\\'; ret[ptr++] = 'r';  continue;
                case '\t': ret[ptr++] = '\\'; ret[ptr++] = 't';  continue;
                case '\v': ret[ptr++] = '\\'; ret[ptr++] = 'v';  continue;
                case '\\': ret[ptr++] = '\\'; ret[ptr++] = '\\'; continue;
                case '\'': ret[ptr++] = '\\'; ret[ptr++] = '\''; continue;
                case '"': ret[ptr++] = '\\'; ret[ptr++] = '"';   continue;
                default:   ret[ptr++] = _str[iter]; continue;
            }
        }
        ret[ptr++] = '\"';
        return ret;
